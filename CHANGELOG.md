...
- Changed AR Foundation dependency version from 6.5.0 to 6.6.0-pre.1.

### Fixed

- Fixed `ARCoreAnchorSubsystem` so that it no longer leaks resources if an error occurs while saving or loading an anchor.
- Fixed `ARCoreAnchorSubsystem` so that it no longer leaks `CancellationTokenRegistration` objects after saving or loading an anchor.
...
- Changed AR Foundation dependency version from 6.5.0-pre.3 to 6.5.0.
...
- Changed AR Foundation dependency version from 6.5.0-pre.1 to 6.5.0-pre.2.
...
- Fixed project validation rules to no longer reference Android API level 25 as the minimum version in Unity 6000.5. The minimum Android API level has been raised to 26 in that Editor version.
...
- Changed AR Foundation dependency version from 6.3.0-pre.2 to 6.3.0.
...
- Changed AR Foundation dependency version from 6.2.0-pre.3 to 6.2.0-pre.4.

## [6.2.0-pre.3] - 2025-04-30

### Changed

- Changed AR Foundation dependency version from 6.2.0-pre.2 to 6.2.0-pre.3.

## [6.2.0-pre.2] - 2025-04-22

### Changed

- Changed AR Foundation dependency version from 6.2.0-pre.1 to 6.2.0-pre.2.
