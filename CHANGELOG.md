...
- Changed AR Foundation dependency version from 6.3.4 to 6.3.5.
...
- Fixed an issue where Android builds on newest versions of Unity would fail due to the upgraded version of Gradle used by those Editor versions. Refer to [Discussions](https://discussions.unity.com/t/info-android-gradle-9-1-0-agp-9-0-0-update-in-unity-6-4/1709062) for more information.

## [6.3.4] - 2026-03-16

### Changed

- Changed AR Foundation dependency version from 6.3.3 to 6.3.4.

## [6.3.3] - 2026-01-26

### Changed

- Changed AR Foundation dependency version from 6.3.2 to 6.3.3.

## [6.3.2] - 2025-12-18

### Changed

- Changed AR Foundation dependency version from 6.3.1 to 6.3.2.
